  ...
  const features = [
    {
      ...
      title: "Audio-to-Text",
      description:
        "Upload audio files and get accurate transcripts in seconds.",
    ...
    },
    {
      ...
      description:
        "Transcribe across supported languages with language-specific prompting.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description:
        "Automatically save transcripts and access them anytime from your dashboard.",
    ...
    },
    {
      ...
      description:
        "GPU-powered transcription optimized for real-world long-form audio.",
  ...
  const testimonials = [
    {
      ...
      content:
        "Meeting notes that used to take an hour are now transcribed and searchable in minutes.",
      rating: 5,
    },
    {
      name: "Marcus Johnson",
      ...
      content:
        "Perfect for interviews and episodes. The transcript quality is excellent and easy to edit.",
      rating: 5,
    },
    {
      name: "Emma Rodriguez",
      role: "Founder",
      content:
        "Our team finally has one place for transcript history. Fast, clean, and reliable.",
      rating: 5,
    },
  ];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-600 sm:text-xl">
              Transcribe audio with high accuracy in seconds. Save your
              transcript history, search your results, and keep everything in
              one place.
            </p>
            ...
            <div className="mt-16 text-center">
              <p className="mb-8 text-sm text-slate-500">
                Trusted by teams, creators, and operators worldwide
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl">
              Powerful Speech-to-Text at Your{" "}
              <span className="bg-gradient-to-r from-indigo-600 to-cyan-600 bg-clip-text text-transparent">
                Fingertips
              </span>
            </h2>
            <p className="mt-4 text-lg text-slate-600">
              Everything you need to transcribe, store, and manage audio content
              with AI.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Upload Audio",
                description:
                  "Upload audio from meetings, podcasts, interviews, or voice notes.",
              },
              {
                step: "02",
                title: "Choose Language",
                description:
                  "Select the transcription language and submit for processing.",
              },
              {
                step: "03",
                title: "Transcribe & Save",
                description:
                  "Review the generated text instantly and keep it in your history.",
              },
            ].map((item, index) => (
      ...
      <section id="testimonials" className="bg-white py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              See what users are saying about Speech to Text Studio
            </p>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              No credit card required. Start transcribing audio instantly.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-r from-indigo-100/70 to-cyan-100/70 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Join teams using AI transcription to turn audio into searchable,
              shareable text.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-16">
            <div className="grid gap-8 md:grid-cols-4">
              <div className="md:col-span-2">
                ...
                <p className="max-w-md text-slate-600">
                  High-quality speech transcription powered by AI. Turn audio
                  into accurate text and manage your transcript history in one
                  workspace.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-600">
                  <li>
                    <Link
                      href="mailto:support@speechtotextstudio.com"
                      className="transition-colors hover:text-indigo-600"
                    >
                      Contact
                    </Link>
            ...
            <div className="mt-16 border-t border-slate-200 pt-8 text-center text-sm text-slate-500">
              <p>&copy; 2026 Speech to Text Studio. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
