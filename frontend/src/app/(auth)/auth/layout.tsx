...
import { Sparkles, AudioLines, Zap, FileText } from "lucide-react";
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
            ...
            <div className="max-w-md">
              <h1 className="mb-6 text-4xl leading-tight font-bold text-violet-50 xl:text-5xl">
                ...
                <span className="text-violet-200">Accurate Text</span>
              </h1>
              <p className="mb-8 text-lg leading-relaxed text-violet-100/90">
                Join teams and creators using AI transcription to convert speech
            ...
            <div className="mt-16 grid grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-violet-300/70">Active Users</div>
              </div>
              <div className="text-center">
